...
//
//
//    __________  __  ___________  __   __ __ ____  ____  ____ _  __
//   / ____/ __ \/  |/  / ____/\ \/ /  / //_// __ \/ __ \/ __ \ |/ /
//  / /   / / / / /|_/ / /_     \  /  / ,<  / /_/ / / / / / / /   / 
// / /___/ /_/ / /  / / __/     / /  / /| |/ _, _/ /_/ / /_/ /   |  
// \____/\____/_/  /_/_/       /_/  /_/ |_/_/ |_|\____/\____/_/|_|  
//                                                                  
// https://nochill.lol
// https://twitter.com/nochillavax
// https://t.me/nochillavax
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1705525200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1705518000;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xAb0fb9ea07CC64703e7954611CF37903bF2Cacdf];
  address public erc20Payable = 0xAb0fb9ea07CC64703e7954611CF37903bF2Cacdf;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 2222) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibsu5cw2q6s5iai4ubvwjw35fn7v2b7yxpd3hs2mveiyg7gddcgna/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/x81qEWMKXS1e6emOtmbn/contract-metadata";
  }
...
// File: contracts/ComfykrooxContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ComfykrooxContract is ERC721APlus {
    constructor() ERC721APlus("COMFY KROOX", "KROOX"){}
}
  /*******************************************************/
  /*                                                     */
